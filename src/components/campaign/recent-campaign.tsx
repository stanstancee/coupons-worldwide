...
export default function RecentCampaigns() {
  ...
  return (
    <div className="w-full  ">
      <div className="flex md:items-center md:justify-between gap-4 md:flex-nowrap flex-wrap py-4">
        ...
        <Link
          href={`/dashboard/campaign/${campaignDetails?.campaign?.uid}/coupons`}
        >
          <Button
            variant="outline"
            size="lg"
                ...
                <TableCell className=" p-5 whitespace-nowrap">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      {row.redeem_status?.toLocaleUpperCase() ===
                        "not redeemed" && (
